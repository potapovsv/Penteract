...
public abstract class RolapAggregationManager {
    ...
    private static final Logger LOGGER = LogManager.getLogger(RolapAggregationManager.class);
    /**
        ...
        List<List<Member>> aggregationList)
    {
        ...
        //     LOGGER.debug(
        //         "getCompoundPredicateInfo: Start aggregationList="
        ...
        //  if (LOGGER.isDebugEnabled()) {
        //     LOGGER.debug(
        //         "getCompoundPredicateInfo: not fastBatchingCellReader="
        //         + aggregationList.size());
        // }
        CompoundPredicateInfo predicateInfo;
        ...
        //  if (LOGGER.isDebugEnabled()) {
        //     LOGGER.debug(
        //         "getCompoundPredicateInfo: End aggregationList="
        //         + aggregationList.size());
        // }        
